    ...
    return (
        <div className="h-screen w-screen overflow-hidden flex items-stretch bg-white dark:bg-slate-900">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 relative">
                ...
                <Link
                    href="/"
                    className="absolute top-8 right-8 hidden lg:flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors group"
                >
                ...
                <div className="w-full max-w-[380px] flex flex-col gap-5">
                    ...
                    <div className="bg-slate-100 dark:bg-slate-800/80 p-1.5 rounded-full grid grid-cols-2 mb-2">
                        ...
                        <Link href="/register" className="text-center py-2 text-sm font-medium text-slate-500 dark:text-slate-400 rounded-full hover:text-slate-800 dark:hover:text-slate-200 transition-colors">
                            Sign Up
                        </Link>
                    </div>
